...
``` 
- **Для запуска следующих команд перейдите в папку** ```...foodgram-project-react/infra/```
...
- Создание аккаунта.
- Просматр: рецепты на главной, отдельные страницы рецептов, страницы пользователей.
